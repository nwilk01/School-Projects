		...
		if(Calculate_Frequency == TRUE)
		{
			/* Check if valid capture event is detected */
				...
				Compute_Frequency();
                    ...
                    UART_UartPutString("Red Value: ");
                    UART_SendDebugData(RGBledData[RED_INDEX]);
                    UART_PutCRLF();
                    UART_UartPutString("Blue Value: ");
                    UART_SendDebugData(RGBledData[BLUE_INDEX]); 
                    UART_PutCRLF();
                    UART_UartPutString("GREEN Value: ");
                    UART_SendDebugData(RGBledData[GREEN_INDEX]); 
                    UART_PutCRLF();
                    UART_UartPutString("Intensity Value: ");
                    UART_SendDebugData(RGBledData[INTENSITY_INDEX]); 
                    UART_PutCRLF();	
				#endif
