...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Buffer_Pos_PC =   (Buffer_Pos_PC & \
                                (uint32)(~(uint32)(Buffer_Pos_DRIVE_MODE_IND_MASK << (Buffer_Pos_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Buffer_Pos_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  Buffer_Pos_DM_STRONG     Strong Drive 
*  Buffer_Pos_DM_OD_HI      Open Drain, Drives High 
*  Buffer_Pos_DM_OD_LO      Open Drain, Drives Low 
*  Buffer_Pos_DM_RES_UP     Resistive Pull Up 
*  Buffer_Pos_DM_RES_DWN    Resistive Pull Down 
*  Buffer_Pos_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Buffer_Pos_DM_DIG_HIZ    High Impedance Digital 
*  Buffer_Pos_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(Buffer_Pos__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro Buffer_Pos_ReadPS calls this function. 
*  
*******************************************************************************/
